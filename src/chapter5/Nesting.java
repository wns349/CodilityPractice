...
public class Nesting {
	 ...
	 * has the form "VW" where V and W are properly nested strings. For example,
	 ...
	 * Assume that:
	 * 
	 * N is an integer within the range [0..1,000,000]; string S consists only
	 * of the characters "(" and/or ")". Complexity:
	 * 
