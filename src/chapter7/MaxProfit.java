...
public class MaxProfit {
	 ...
	 * then the profit of such transaction is equal to A[Q] − A[P], provided
	 ...
	 * 21367 If a share was bought on day 0 and sold on day 2, a loss of 2048
	 * would occur because A[2] − A[0] = 21123 − 23171 = −2048. If a share was
	 * bought on day 4 and sold on day 5, a profit of 354 would occur because
	 ...
	 * 
	 * that, given a zero-indexed array A consisting of N integers containing
	 * daily prices of a stock share for a period of N consecutive days, returns
	 * the maximum possible profit from one transaction during this period. The
	 ...
	 * an integer within the range [0..200,000]. Complexity:
	 * 
