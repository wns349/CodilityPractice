...
public class MaxSliceSum {
	 ...
	 * 
	 * A[0] = 3 A[1] = 2 A[2] = -6 A[3] = 4 A[4] = 0 the function should return
	 * 5 because:
	 * 
	 * (3, 4) is a slice of A that has sum 4, (2, 2) is a slice of A that has
	 * sum −6, (0, 1) is a slice of A that has sum 5, no other slice of A has
	 * sum greater than (0, 1). Assume that:
	 * 
	...
	public int solution(int[] A) {
		...
		for (int i = 1; i < A.length; i++) {
			...
			maxEnd = maxEnd < maxSum ? maxSum : maxEnd;
		}
